  ...
  function loadReportEvents(reportId) {
    ...
    fetch(reportsEndpoint)
      ...
      .then(body => {
        ...
        drawGenericChart('#top-speed-events-chart', 'Top speed events', topSpeedEvents, [0, 1800], [160, 0], 'Km/h');
        ...
        drawGenericChart('#fuel-level-events-chart', 'Fuel level events', fuelLevelEvents, [0, 1800], [100, 0], 'Percentage');
        ...
        drawGenericChart('#speed-delta-events-chart', 'Speed delta events', speedChangeEvents, [0, 1800], [100, -100], 'Km/h');
        ...
        drawGenericChart('#top-rpm-events-chart', 'Top RPM events', topRPMEvents, [0, 1800], [5000, 0], 'RPM');
      });
  }
